...
namespace mijingo\learningpathways\records;
 ...
 * @since     0.0.1
 */
class LearningPathwaysRecord extends ActiveRecord
{
    ...
    {
        return '{{%learningpathways_learningpathwaysrecord}}';
    }
}
